 ...
 * All interaction handling: messages, sidebar, theme, export, formatting.
 * Built with jQuery + vanilla JS.
 */
...
$(function () {
  ...
  /* =========================================
      ...
      — varied enough to feel semi-realistic
  ========================================= */
  const aiResponses = [
  ...
  /* =========================================
      Format text — basic markdown-ish parsing
  ...
  /* =========================================
      addMessage — creates and appends a message bubble
  ...
  function addMessage(text, sender, typewriter = false) {
    ...
    // Build message HTML — empty bubble if typewriter mode
    ...
    messageHistory.push({ sender: name, text, time });
  }
  ...
  /* =========================================
      sendMessage — orchestrates the send flow
  ========================================= */
  function sendMessage() {
    ...
    $('#welcomeScreen').fadeOut(250, function () {
      $(this).remove();
    });
    ...
    // Simulate AI thinking — random 1-2s delay
    ...
    setTimeout(function () {
      ...
      addMessage(response, 'ai', true); // typewriter on
